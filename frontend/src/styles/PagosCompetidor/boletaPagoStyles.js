...
export const boletaStyles = StyleSheet.create({
  ...
  title: { textAlign: 'center', fontSize: 16, fontWeight: 'bold', marginTop: 2, marginBottom: 8 },
  infoTableRight: { alignSelf: 'flex-end', gap: 1, marginBottom: 20, marginRight: 10, width: 130 },
