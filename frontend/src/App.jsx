...
import TutorRegistroPage from "./pages/TutorRegistroPage";
    ...
    <Router>
      ...
      <div className="container mx-auto p-4">
        <Routes>
          ...
          <Route
            path="/ingresar"
            element={<InicioAdministrador setIsAdmin={setIsAdmin} />}
          />
          <Route
            path="/admin"
            element={<AdminRedirect setIsAdmin={setIsAdmin} />}
          />
          <Route path="/registrar-tutores" element={<RegistrarTutores />} />{" "}
          {/* Ruta para RegistrarTutores */}
          <Route path="/registrar-disciplinas" element={<TablaArea />} />
          <Route path="/registro-tutor" element={<TutorRegistroPage />} />
        </Routes>
      </div>
    </Router>
  );
