  ...
  return (
    <div className="card-convocatoria">
      ...
      <div className="card-fecha">
        ...
        <span>{data.fecha_inicio.split('T')[0].split('-').reverse().join('/')} - {data.fecha_fin.split('T')[0].split('-').reverse().join('/')}</span>
      </div>
      
      <div className="card-fecha">
        <span>Competencia:</span>
        <span>{data.competicion_inicio.split('T')[0].split('-').reverse().join('/')} - {data.competicion_fin.split('T')[0].split('-').reverse().join('/')}</span>
      </div>
