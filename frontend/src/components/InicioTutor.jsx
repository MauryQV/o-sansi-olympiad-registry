...
const InicioTutor = () => {
  ...
  const pendientes = [
    { id: 1, nombre: 'Maria Gonzáles', area: 'Matemática - Categoría: Quinto Nivel', grado: '5to de Secundaria' },
    { id: 2, nombre: 'Juan Pérez', area: 'Física - Categoría: 4S', grado: '4to de Secundaria' },
  ];
  ...
  return (
    <div className="tutor-inicio-wrapper">
      ...
      <div className="tutor-inicio-content"> {/* Nuevo contenedor para alinear */}
